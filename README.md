...
Подключение EspHome к счетчикам электроэнергии по протоколу DLMS/COSEM/СПОДЭС (Энергомера CE207, CE307, CE308, Милур 107S и другие)
через RS-485 интерфейст или через оптопорт.
...
Необходимо в каждом случае смотреть инструкцию к счетчику.
## Клиент
...
Тут разрабочики Милур постарались да и еще инструкцию кто-то писал под воздействием неправильной фазы луны. Про HEX забываем.
Берем серийный номер счетчика, например: `241100010880560`, последние цифры = `0560`, добавляем `16`, получаем `576`. 
